...
extern "C" {
    ...
    MLAS_QUANTIZE_INT8_BINARY_ELEMENTWISE_KERNEL_ROUTINE MlasQuantizeLinearAddKernel_S8;
    MLAS_QUANTIZE_UINT8_BINARY_ELEMENTWISE_KERNEL_ROUTINE MlasQuantizeLinearAddKernel_U8;

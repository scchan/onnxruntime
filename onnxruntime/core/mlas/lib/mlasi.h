...
extern "C" {
    ...
    MLAS_QUANTIZE_INT8_BINARY_ELEMENTWISE_KERNEL_ROUTINE MlasQLinearAddS8Kernel;
    MLAS_QUANTIZE_UINT8_BINARY_ELEMENTWISE_KERNEL_ROUTINE MlasQLinearAddU8Kernel;
    ...
    MLAS_QUANTIZE_INT8_BINARY_ELEMENTWISE_KERNEL_ROUTINE MlasQLinearAddS8KernelAvx2;
    MLAS_QUANTIZE_UINT8_BINARY_ELEMENTWISE_KERNEL_ROUTINE MlasQLinearAddU8KernelAvx2;
#endif
...
struct MLAS_PLATFORM {
    ...
    PMLAS_QUANTIZE_INT8_BINARY_ELEMENTWISE_KERNEL_ROUTINE QLinearAddS8Kernel;
    PMLAS_QUANTIZE_UINT8_BINARY_ELEMENTWISE_KERNEL_ROUTINE QLinearAddU8Kernel;

...
#define LAYERNORMGRAD_IMPL(T, U)                                                                                                             \
  template void HostLayerNormGradient(const hipDeviceProp_t& prop, const T* dout, const U* mean, const U* invvar, const T* input, int64_t n1, int64_t n2, const T* gamma, \
